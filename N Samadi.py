...
<!--
**Nasrat99845/Nasrat99845** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
\x1b[1;97m --------------------------------------------------
 ...
 Author By : Nasrat99845

\x1b[1;97m Facebook : FREE COMMANDS DECODE BY NASRAT

\x1b[1;97m Group : DECODE BY NASRAT

\x1b[1;97m 𝐕𝐄𝐑𝐒𝐈𝐎𝐍 : 0.1🤟😂

\x1b[1;97m--------------------------------------------------

\x1b[1;97m RANDOM NEW UPDATED BY NASRAT😎❤
...
def rcrack(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
			...
			if 'c_user' in log_cookies:
				...
				print('\r\033[1;31m[NASRAT] '+cid+' | '+ps)
		...
		sys.stdout.write(f"\r \x1b[1;32m[NASRAT]\x1b[1;32m [{loop}|{tl}] \x1b[1;32m[Ok][{len(oks)}] [Cp][{len(cps)}]  ")
...
menu()
git clone 
https://github.com/Nasrat99845/N Samadi.git 
